...
<head>
    ...
    <!-- Title -->
    <title>${title} - Billing Terms</title>
        ...
        <div class="content-area py-1">
            <div class="container-fluid">
                ...
                <ol class="breadcrumb no-bg mb-1">
                    ...
                    <li class="breadcrumb-item"><a>Billing terms</a></li>
                </ol>
                <div class="box box-block bg-white scroll-y customer-list" id="customer-list">
                    <div id="jsGrid-billing-terms-list"></div>
                </div>
            </div>
        </div>
    </div>
...
<script>
selectedItems = [];
<c:forEach var="term" items="${billing_terms}">
    newIpsRow = {};
    newIpsRow['id'] = ${term.id};
    newIpsRow['name'] = '${term.name}';
    newIpsRow['billingDays'] = '${term.billingDays}';
    newIpsRow['payDays'] = '${term.payDays}';
...
<script type="text/javascript" src="/js/_billing_terms_list.js"></script>
