...
<head>
    ...
    <!-- Title -->
    <title>${title} - Report - Statement Of Accounts</title>
...
<div class="wrapper">
    ...
    <li class="nav-item dropdown">
        <a href="#" class="nav-link">
            <button type="button"
                    class="btn btn-success w-min-sm mb-0-25 waves-effect waves-light generate" onclick="loadReport()" id="btn_generate">
                Generate
            </button>
        </a>
    </li>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <ol class="breadcrumb no-bg mb-1">
                            ...
                            <li class="breadcrumb-item"><a>Statement of accounts</a></li>
                        </ol>
                    </div>
                </div>
...
<script src="/js/select2.min.js"></script>
<script type="text/javascript" src="/js/_soa.js"></script>
<script>
