...
<head>
    ...
    <link rel="stylesheet" href="/css/_sms_incoming_payment_list.css">
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <ol class="breadcrumb no-bg mb-1">
                            ...
                            <li class="breadcrumb-item"><a>Incoming payments</a></li>
                        </ol>
                    </div>
...
<script type="text/javascript" src="/js/_sms_incoming_payment_list.js"></script>
