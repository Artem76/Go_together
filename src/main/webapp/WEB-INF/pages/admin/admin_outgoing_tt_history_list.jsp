...
<head>
    ...
    <!-- Title -->
    <title>${title} - Outgoing TTs History</title>
...
<div class="wrapper">
    ...
    <li class="nav-item dropdown">
        <a href="#" class="nav-link">
            <button type="button"
                    class="btn btn-success w-min-sm mb-0-25 waves-effect waves-light generate" onclick="getOutgoingTTByFilteres()">
                Search
            </button>
        </a>
    </li>
...
<script type="text/javascript" src="/js/_outgoing_tt_history_list.js"></script>
