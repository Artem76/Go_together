...
<div class="wrapper">
    ...
    <li class="nav-item dropdown">
        <a href="/admin_full_refbook_edit?id_refbook=0&type=country&error" class="nav-link">
            <button class="btn btn-outline-primary">New country</button>
        </a>
    </li>
...
<script>
    ...
    newIpsRow['country'] = '${refbook.country}';
...
<script type="text/javascript" src="/js/_refbook.js"></script>
