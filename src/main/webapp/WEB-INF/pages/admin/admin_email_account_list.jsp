...
<head>
    ...
    <!-- Title -->
    <title>${title} - Email Accounts</title>
...
<div class="wrapper">
    ...
    <li class="nav-item dropdown">
        <a href="/admin_full_email_account_edit?id_email_account=0" class="nav-link">
            <button class="btn btn-outline-primary">Add new email account</button>
        </a>
    </li>
    <li class="nav-item dropdown">
        <a href="/admin_full_email_account_invisible_list" class="nav-link">
            <button class="btn btn-outline-primary">Invisible email account</button>
        </a>
    </li>
