...
<div class="wrapper">
    ...
    <li class="nav-item dropdown">
        <a href="#" class="nav-link">
            <button class="btn btn-outline-primary" onclick="addDialcode()">New dialcode</button>
        </a>
    </li>
    ...
    <div class="site-content">
        ...
        <div class="content-area py-1">
            <div class="container-fluid">
                ...
                <input type="hidden" id="mnc" value="${mnc}">
                <h4>${country_name}</h4>
...
<script type="text/javascript" src="/js/_refbook_dialcode_list.js"></script>
