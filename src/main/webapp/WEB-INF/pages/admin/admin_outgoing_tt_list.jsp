...
<head>
    ...
    <!-- Title -->
    <title>${title} - Outgoing TTs</title>
...
<div class="wrapper">
    ...
    <li class="nav-item dropdown">
        <a href="/admin_full_outgoing_tt_edit?id_outgoing_tt=0" class="nav-link">
            <button class="btn btn-outline-primary">New TT</button>
        </a>
    </li>
    <li class="nav-item dropdown">
        <a href="/admin_full_outgoing_tt_history_list" class="nav-link">
    ...
    <div class="site-content">
        ...
        <div class="content-area py-1">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6">
                        <h4>Outgoing trouble tickets</h4>
...
<script type="text/javascript" src="/js/_outgoing_tt_list.js"></script>
