...
<div class="wrapper">
    ...
    <form id="mainform" method="post" action="/admin_full_company_edit_save">
        ...
        <li class="nav-item dropdown">
            <a href="/admin_full_company_list" data-toggle="" aria-expanded="false" class="nav-link">
                ...
                <div class="container-fluid">
                    ...
                    <div class="box box-block bg-white content_customer" style="border-top: 0">
                        <div class="form-group">
                            ...
                            <input type="text" value="${company.name}" class="form-control" id="name"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="${company.address}" class="form-control" id="address"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="${company.registration_number}" class="form-control" id="registration_number"
                                   aria-describedby="emailHelp" placeholder="Registration number" name="registration_number">
                        </div>
                        <div class="clearfix"></div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="${company.vat}" class="form-control" id="vat"
                                   aria-describedby="emailHelp" placeholder="VAT" name="vat">
                        </div>
                        <div class="form-group">
                            <label for="documentsPrefix">Documents prefix</label>
                            <input type="text" value="${company.documentsPrefix}" class="form-control" id="documentsPrefix"
                                   aria-describedby="emailHelp" placeholder="Documents prefix" name="documentsPrefix">
                        </div>
                        <div class="form-group">
                            <label for="currentBankAccount_id">Bank account</label><br>
                            <select class="js-example-basic-single dd_menu" name="currentBankAccount_id"
                                    id="currentBankAccount_id" style="width: 200px">
                                <c:if test="${empty company.currentBankAccount_id}">
                                    <option value="0">Not set</option>
                                </c:if>
                                <c:if test="${not empty company.currentBankAccount_id}">
                                    <option value="${company.currentBankAccount_id}">${bank_account_name}</option>
                                </c:if>
                                <c:forEach var="account" items="${bank_accounts}">
                                    <c:if test="${account.id ne company.currentBankAccount_id}">
