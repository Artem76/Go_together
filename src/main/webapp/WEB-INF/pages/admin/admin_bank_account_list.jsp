...
<head>
    ...
    <!-- Title -->
    <title>${title} - Bank Accounts</title>
...
<div class="wrapper">
    ...
    <li class="nav-item dropdown">
        <a href="/admin_full_bank_account_edit?id_bank_account=0&error=&err_name=" data-toggle=""
        ...
        <div class="content-area py-1">
            <div class="container-fluid">
                ...
                <div class="box box-block bg-white scroll-y customer-list" id="customer-list">
                    <div id="jsGrid-bank_account-list"></div>
                </div>
            </div>
        </div>
    </div>
...
<c:forEach var="bank" items="${banks}">
    newIpsRow = {};
    newIpsRow['id'] = ${bank.id};
    newIpsRow['name'] = '${bank.name}';
    newIpsRow['account_number'] = '${bank.account_number}';
    newIpsRow['iban'] = '${bank.iban}';
    newIpsRow['swift'] = '${bank.swift}';
...
<script type="text/javascript" src="/js/_bank_account_list.js"></script>
