...
<head>
    ...
    <!-- Title -->
    <title>${title} - Outgoing Invoices</title>
...
<%--
    <li class="nav-item dropdown">
        <a href="#" aria-expanded="false" class="nav-link">
            <button type="button" class="btn btn-outline-primary" id="pdf">Create PDF</button>
        </a>
    </li>--%>
        ...
        <div class="content-area py-1">
            <div class="container-fluid">
                ...
                <div class="box box-block bg-white scroll-y customer-list" id="customer-list">
                    <div id="jsGrid-invoice-list"></div>
                </div>
            </div>
        </div>
    </div>
...
<c:forEach var="invoice" items="${invoices}">
    newIpsRow = {};
    newIpsRow['id'] = ${invoice.id};
    newIpsRow['invoiceSum'] = '${invoice.sum}';
    newIpsRow['customer'] = '${invoice.customerName}';
    newIpsRow['number'] = '${invoice.invoiceNumber}';
    newIpsRow['date'] = '${invoice.date}';
    newIpsRow['billingPeriodName'] = '${invoice.billingPeriodName}';
    newIpsRow['startDate'] = '${invoice.startDate}';
    newIpsRow['endDate'] = '${invoice.endDate}';
    newIpsRow['payDate'] = '${invoice.payDate}';
    newIpsRow['sent_to'] = '${invoice.sent_to}';
...
<script type="text/javascript" src="/js/_outgoing_invoice_list.js"></script>
