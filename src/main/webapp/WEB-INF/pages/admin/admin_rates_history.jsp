...
<head>
    ...
    <!-- Title -->
    <title>${title} - Report - Rates History</title>
        ...
        <a href="#" class="nav-link">
            <select id="customer" class="dd_menu client_menu js-example-basic-single select_static"
                ...
                <c:forEach var="client" items="${clients}">
                    <option mode="client" value="${client.id}"> Client - ${client.getCustomer().getName()} - ${client.name}</option>
                </c:forEach>
                <c:forEach var="vendor" items="${vendors}">
                    <option mode="vendor" value="${vendor.id}"> Vendor - ${vendor.getSmppVendorAccount().getCustomer().getName()} - ${vendor.getSmppVendorAccount().getName()} - ${vendor.getSystemId()}</option>
                </c:forEach>
            </select>
        </a>
    </li>
        ...
        <div class="content-area py-1">
            <div class="container-fluid">
                ...
                <ol class="breadcrumb no-bg mb-1">
                    ...
                    <li class="breadcrumb-item"><a>Rates history</a></li>
                </ol>
...
<script type="text/javascript" src="/js/_rate_history.js"></script>
