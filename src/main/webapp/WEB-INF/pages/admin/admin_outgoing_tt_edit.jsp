...
<head>
    ...
    <link rel="stylesheet" href="/css/_outgoing_tt_edit.css">
    ...
    <div class="site-content">
        ...
        <div class="content-area py-1">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6">
                        <h4>Outgoing trouble ticket update</h4>
                        <ol class="breadcrumb no-bg mb-1">
                            <li class="breadcrumb-item"><a>Trouble tickets</a></li>
                            <li class="breadcrumb-item"><a>Outgoing</a></li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="box box-block bg-white scroll-x content_tt" style="border-top: 0">
                    <div class="tab-content">
                        ...
                        <div class="tab-pane active" id="tt" role="tabpanel">
                            <div class="form_outgoingTT">
                                <input type="hidden" name="id_tt" value="${id_tt}" id="id_tt">
                                <div class="form-group">
                                    <label for="status">Status</label><br>
                                    <select class="form-control" name="status" id="status">
                                        <c:if test="${tt.status eq status_opened}">
                                            <option value="${status_opened}">
                                                <c:out value="${status_opened.toString()}"/>
                                            </option>
                                            <option value="${status_closed}">
                                                <c:out value="${status_closed.toString()}"/>
                                            </option>
                                        </c:if>
                                        <c:if test="${tt.status ne status_opened}">
                                            <option value="${status_closed}">
                                                <c:out value="${status_closed.toString()}"/>
                                            </option>
                                            <option value="${status_opened}">
                                ...
                                <div class="scroll-x" name="messageLogForTTList">
                                    <div id="jsGrid-outgoing-tt-complain-list"></div>
                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-8 offset-md-2">
                                                    <div class="flex-container">
                                                            <textarea
                                                                    class="form-control new_email_body"
                    ...
                    <div id="modal_first_email" class="modal <%--animated flipInX--%> fade small-modal" tabindex="-1"
                        ...
                        <div class="modal-dialog modal-sm">
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <h4 class="modal-title" id="myModalFirstEmail" style="text-align: center">Do you want send email?</h4>
                                </div>
                                <%--<div class="modal-body">
                                    Modal content
                                </div>--%>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-primary" id="first_email_send">Send</button>
                                    <button type="button" class="btn btn-danger" id="first_email_cancel">Cancel</button>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script>
    ...
    document.emailsEmpty = ${empty emailContentList};
</script>

<script type="text/javascript" src="/js/_main.js"></script>
<script type="text/javascript" src="/js/_outgoing_tt_edit.js"></script>
