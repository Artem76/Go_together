...
<div class="wrapper">
    ...
    <form id="mainform" method="post" action="/admin_full_refbook_edit_save">
        ...
        <input type="hidden" name="mcc_refbook" value="${mcc}">
        <input type="hidden" name="state" value="network">
        ...
        <li class="nav-item dropdown">
            <a href="/admin_full_refbook_network_list?mcc=${mcc}" data-toggle="" aria-expanded="false" class="nav-link">
        ...
        <c:if test="${id_refbook ne 0}">
            <li class="nav-item dropdown">
                <a href="#" data-toggle="" aria-expanded="false" class="nav-link">
                    <button type="button" class="btn btn-outline-danger" onclick="deleteRefboook('${id_refbook}', 'network', '${mcc}', '${mnc}')">Delete
                    </button>
                </a>
            </li>
        </c:if>
            ...
            <div class="content-area py-1">
                ...
                <div class="container-fluid">
                    ...
                    <ol class="breadcrumb no-bg mb-1">
                        ...
                        <li class="breadcrumb-item"><a>${country_title}</a></li>
                    </ol>
                    <div class="box box-block bg-white" id="content">
                        <div class="form-group">
                            <label for="network">Network name</label>
                            <input type="text" value="${refbook.network}" class="form-control" id="network"
                                   placeholder="Network name" name="network_refbook">
                        </div>
                        <div class="form-group">
                            <label for="mnc">MNC</label>
                            <input type="text" value="${refbook.mnc}" class="form-control" id="mnc"
                                   placeholder="MNC" name="mnc_refbook">
                        </div>
                        <div class="form-group">
