...
<div class="wrapper">
    ...
    <form id="mainform" method="post" action="/admin_full_refbook_edit_save">
        ...
        <input type="hidden" name="mnc_refbook" value="${mnc}">
        <input type="hidden" name="state" value="dialcode">
        <!-- Header -->
        ...
        <li class="nav-item dropdown">
            <a href="/admin_full_refbook_dialcode_list?mcc=${mcc}&mnc=${mnc}" data-toggle="" aria-expanded="false" class="nav-link">
        ...
        <c:if test="${id_refbook ne 0}">
            <li class="nav-item dropdown">
                <a href="#" data-toggle="" aria-expanded="false" class="nav-link">
                    <button type="button" class="btn btn-outline-danger" onclick="deleteRefboook('${id_refbook}', 'dialcode', '${mcc}', '${mnc}')">Delete
                    </button>
                </a>
            </li>
        </c:if>
