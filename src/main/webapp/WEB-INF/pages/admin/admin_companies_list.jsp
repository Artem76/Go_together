...
<div class="wrapper">
    ...
    <li class="nav-item dropdown">
        <a href="/admin_full_company_edit?id_company=0&error=&err_name=" data-toggle=""
           aria-expanded="false" class="nav-link">
            <button class="btn btn-outline-primary">New company</button>
        </a>
    </li>
        ...
        <div class="content-area py-1">
            <div class="container-fluid">
                ...
                <div class="box box-block bg-white scroll-y customer-list" id="customer-list">
                    <div id="jsGrid-companies-list"></div>
                </div>
            </div>
        </div>
    </div>
...
<c:forEach var="company" items="${companies}">
    newIpsRow = {};
    newIpsRow['id'] = ${company.id};
    newIpsRow['name'] = '${company.name}';
    newIpsRow['address'] = '${company.address}';
    newIpsRow['registration_number'] = '${company.registration_number}';
...
<script type="text/javascript" src="/js/_companies_list.js"></script>
