        ...
        $("#jsGrid-refbook").jsGrid({
            ...
            rowClick: function (args) {
                if (args.event.target.classList.contains("btn") || args.event.target.classList.contains("ti-pencil")) {
                    document.location.href = "/admin_full_refbook_edit?id_refbook=" + args.item.id + "&type=network" + "&mcc=" + $("#mcc").val() + "&error=";
                } else {
                    document.location.href = "/admin_full_refbook_dialcode_list?mcc=" + args.item.mcc + "&mnc=" + args.item.mnc;
                }
            },
            fields: [
                ...
                {title: "Network", name: "network", type: "text", width: 200, align: "center"},
...
function addNetwork() {
    window.location = "/admin_full_refbook_edit?id_refbook=0&type=network&mcc=" + $("#mcc").val() + "&error"
}
