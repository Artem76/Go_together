        ...
        $("#jsGrid-refbook").jsGrid({
            ...
            rowClick: function (args) {
                if (args.event.target.classList.contains("btn") || args.event.target.classList.contains("ti-pencil")) {
                    document.location.href = "/admin_full_refbook_edit?id_refbook=" + args.item.id + "&type=dialcode" + "&mcc=" + $("#mcc").val() + "&mnc=" + $("#mnc").val() + "&error=";
                }
            },
            fields: [
                ...
                }, title: "", name: "edit", type: "text", width: 25, align: "center"},
                {title: "id", name: "id", type: "text", width: 200, align: "center", visible: false},
                {title: "Dialcode", name: "dialcode", type: "text", width: 300, align: "center"},
...
function addDialcode() {
    window.location = "/admin_full_refbook_edit?id_refbook=0&type=dialcode&mcc=" + $("#mcc").val() + "&mnc=" + $("#mnc").val() +"&error"
}