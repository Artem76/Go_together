...
$(document).ready(function () {
    ...
    window.jsGrid_init = function () {
        $("#jsGrid-bank_account-list").jsGrid({
            ...
            rowClick: function (args) {
                document.location.href = "/admin_full_bank_account_edit?id_bank_account=" + args.item.id + "&error=&err_name=";
            },
            fields: [
                {title: "id", name: "id", type: "text", width: 100, align: "center", visible: false},
                {title: "Name", name: "name", type: "text", width: 200, align: "center"},
                {title: "Account number", name: "account_number", type: "text", width: 150, align: "center"},
                {title: "IBAN", name: "iban", type: "text", width: 150, align: "center"},
                {title: "SWIFT", name: "swift", type: "text", width: 150, align: "center"}
            ],
        });
    };
