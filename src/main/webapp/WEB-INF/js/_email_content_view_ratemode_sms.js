            ...
            rowRenderer: function (item, itemIndex) {
                if ((itemIndex % 2) == 0) {
                    return $('<tr>').css("backgroundColor", "white")
                        ...
                        .append($('<a>').attr("href", "/admin_full_vendor_rn_edit?id_vendor_rn=0&id_email_content=" + document.emailContent_id + "&id_email_attachment=" + item.id).css({"color": "#55595c", "width": "100%", "display": "block"})
