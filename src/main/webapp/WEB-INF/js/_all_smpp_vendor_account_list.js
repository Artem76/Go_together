/**
 * Created by АРТЕМ on 04.12.2017.
 */
(function () {
    ...
    var db = {
        ...
        loadData: function (filter) {
            var list = [];
            $.each(smppVendorAccountList, function (n, row) {
        ...
        $("#jsGrid-accounts").jsGrid({
            ...
            rowClick: function (args) {
                /*if (args.item.customer == args.event.target.innerHTML) {
                    ...
                    document.location.href = "/admin_full_smpp_vendor_account_edit?id_vendor_account=" + args.item.idAccount + "&id_customer=" + args.item.idCustomer + "&error=&err_name=&err_ips=&return_in_customer=no";
                // }
