...
$(document).ready(function () {
    ...
    if (document.getElementById('jsGrid-outgoing-tt')) {
    ...
    window.jsGrid_init();
    getOutgoingTTByFilteres();
});


function getOutgoingTTByFilteres() {
    ...
    db.tts = [];
    window.jsGrid_init();
    $.getJSON('/admin_full_get_outgoing_tt_history_list',
        {
