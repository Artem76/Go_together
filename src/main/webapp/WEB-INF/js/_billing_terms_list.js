...
$(document).ready(function () {
    ...
    window.jsGrid_init = function () {
        $("#jsGrid-billing-terms-list").jsGrid({
            ...
            fields: [
                ...
                {title: "Name", name: "name", type: "text", width: 300, align: "center"},
                {title: "Billing days", name: "billingDays", type: "text", width: 150, align: "center"},
                {title: "Pay days", name: "payDays", type: "text", width: 150, align: "center"},
            ],
        });
    };
