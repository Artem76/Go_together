...
public class IncomingTTXML {
    ...
    public IncomingTTXML(Long id, String customer, String dateOpened, String dateClosed, String userOpened, String userClosed, String status, String subject) {
        this.id = id;
    ...
    public IncomingTTXML(Long id, String customer, String dateOpened, String dateClosed, String userOpened, String userClosed, String status, String subject, Integer externalTTCount, Integer externalTTClosed) {
        this.id = id;
        this.customer = customer;
        this.dateOpened = dateOpened;
        this.dateClosed = dateClosed;
